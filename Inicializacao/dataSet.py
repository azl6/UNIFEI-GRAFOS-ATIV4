...
def criaMatrizAdjacencias(instancia):
    ...
    caminho = 'C:\\Users\\Alex\\Desktop\\T1- ALEX SILVA RODRIGUES\\ativ3\\Instancias\\' + instancia + '.txt'
...
def salvaResultado(resultado):
    ...
    for res in resultado:
        stringRes += str(res) + ' '
    arquivo = open('C:\\Users\\Alex\\Desktop\\T1- ALEX SILVA RODRIGUES\\ativ3\\Resultados\\resultado.txt', 'a+')
